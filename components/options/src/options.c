...
static void print_long_info(char *argv0)
{
    fprintf(stdout, "\nUsage: %s [-A S-LDM coverage internal area] [options]\n"
                    ...
                    "[options]:\n" OPT_A_description OPT_E_description OPT_F_description OPT_c_description OPT_U_description OPT_Q_description OPT_r_description OPT_s_description OPT_Z_description OPT_z_description OPT_w_description OPT_L_description OPT_C_description OPT_g_description OPT_u_description OPT_p_description OPT_R_description OPT_S_description OPT_I_description OPT_O_description OPT_o_description OPT_vehviz_update_interval_sec_description OPT_indicator_trgman_disable_description OPT_disable_quadkey_filter_description OPT_enable_left_indicator_trigger OPT_enable_ext_lights_hijack OPT_enable_interop_hijack OPT_ms_rest_periodicity OPT_gn_timestamp_property OPT_amqp_main_idle_timeout OPT_amqp_main_reconn_local_timeout_exp OPT_brokers_enable_description,
            argv0, argv0, argv0);
